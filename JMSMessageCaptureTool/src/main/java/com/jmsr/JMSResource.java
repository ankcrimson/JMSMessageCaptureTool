...
env.put(Context.SECURITY_CREDENTIALS, "$35aps1757");
...
JMSSystemResourceMBean jmsSR = JMSModuleHelper.findJMSSystemResource(ctx, resourceName);
...
String portString = "9001";
String username = "Admin";
String password = "$35aps1757";
